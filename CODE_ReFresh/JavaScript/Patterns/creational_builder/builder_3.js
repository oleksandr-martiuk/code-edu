...
// 0. Customer work:
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
const notebookBuilderZ05 = new NotebookBuilderZ05('Quadro');   // 1. Клиент делает запросс конкретному билдеру
const baseCompDirector = new ShopDirectorBase();                     // 2. Конкретній директор задает процедуру постройки
baseCompDirector.construct(notebookBuilderZ05);
const notebookResult = notebookBuilderZ05.getComputer();             // 3. Билдер отдает резульатат клиенту
