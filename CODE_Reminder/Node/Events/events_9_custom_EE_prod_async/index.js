...
(async () => {
   ee.on('e1', async () => console.log('e1 listener 1'));
   ee.on('e1', async () => console.log('e1 listener 2'));
   ee.on('e1', async () => console.log('e1 listener 3'));
   ee.on('e2', async () => console.log('e2 listener 1'));
   ee.on('e2', async () => console.log('e2 listener 2'));
