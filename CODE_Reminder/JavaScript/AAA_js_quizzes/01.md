...
###### 107. Which of these methods modifies the original array?
...
###### 114. Which method(s) will return the value `'Hello world!'`?
...
###### 116. Which of the following options will return `6`?
...
###### 133. How can we invoke `sum` in `sum.js` from `index.js?`
...
###### 135. Which of the following will modify the `person` object?
...
###### 142. Which of the options result(s) in an error?
...
###### 143. What do we need to add to the `person` object to get `["Lydia Hallie", 21]` as the output of `[...person]`?
